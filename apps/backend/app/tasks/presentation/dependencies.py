...
def get_list_task_shares_use_case() -> ListTaskSharesUseCase:
    ...
    return _resolve(
        "list_task_shares_use_case",
        lambda: build_container().list_task_shares_use_case,
    )
...
def get_delete_task_categories_use_case() -> DeleteTaskCategoriesUseCase:
    ...
    return _resolve(
        "delete_task_categories_use_case",
        lambda: build_container().delete_task_categories_use_case,
    )
...
def get_update_task_category_use_case() -> UpdateTaskCategoryUseCase:
    ...
    return _resolve(
        "update_task_category_use_case",
        lambda: build_container().update_task_category_use_case,
    )
